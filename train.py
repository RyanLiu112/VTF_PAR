    ...
    for i in range(start_epoch, epoch + 1):
        ...
        for idx in range(len(index_list) - 1):
            if index_list[idx + 1] - index_list[idx] > 1:
                result = get_pedestrian_metrics(
                    valid_gt[:, index_list[idx]:index_list[idx + 1]], valid_probs[:, index_list[idx]:index_list[idx + 1]]
                )
            elif idx < 9:
        ...
        print(
            f'{time_str()}Evaluation on test set, valid_loss:{valid_loss:.4f}\n',
            ...
            'average_ma: {:.4f},  average_acc: {:.4f},average_prec: {:.4f},average_recall: {:.4f},average_f1: {:.4f}'.format(
                average_ma, average_acc, average_prec, average_recall, average_instance_f1
            )
        )
        print('-' * 60)
