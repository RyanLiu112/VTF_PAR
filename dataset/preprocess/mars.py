...
attr_words = [
    ...
    # top color [20 :29]
    'bottom white', 'bottom purple', 'bottom black', 'bottom green', 'bottom gray', 'bottom pink', 'bottom yellow', 'bottom blue',
    'bottom brown', 'bottom complex',
    # bottom color[29:39]
...
def generate_data_description(save_dir):
    ...
    trainval_name_file = open(
        "/amax/DATA/jinjiandong/VTB-main/dataset/MARS/mars_annotation/base_train.txt", 'r', encoding='utf8'
    ).readlines()
